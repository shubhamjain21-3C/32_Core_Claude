              ...
              {tab === 'description' && (
                <div className="space-y-8">
                  <div className="rounded-xl p-4 flex gap-3" style={{ background: 'rgba(212,134,10,0.08)', border: '1px solid rgba(212,134,10,0.25)' }}>
                    ...
                    <div>
                      <p className="font-semibold text-[#2C1F14] text-sm">AI Evidence Analysis — Powered by Claude</p>
                      <p className="text-xs text-[#8B3A2A] mt-0.5">Our AI reviews submitted evidence — inventory reports, photos, correspondence — and produces a structured summary to help mediators reach fair, evidence-based outcomes faster.</p>
                    </div>
                  </div>
